...
haiku = f"### Instruction: Write a haiku, including the words: {ecology_word}, {renewal_word}, {positivity_word}, {regeneration_word}, {indigenous_word}. ### Response:"
...
subprocess.run(['python3', 'tts_script.py', timename])
